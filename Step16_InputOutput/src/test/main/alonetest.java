...
public class alonetest {
	public static void main(String[] args) {
		...
		try {
			...
			fis = new FileInputStream("C:\\Users\\acorn\\Desktop\\playground\\myFolder\\428.png");
			//byte 알갱이를 파일에 출력할 객체생성
			fos = new FileOutputStream("C:\\Users\\acorn\\Desktop\\playground\\myFolder\\428p.png");
			
			//byte 알갱이 여러개를 한번에 담을 배열 미리 준비
			byte[] buffer = new byte[100]; //1kb를 읽을수있는 배열의사이즈 준비
